...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function initUniqueViewCounter() {
    const VISITED_KEY = 'abbys_unique_visitor_v3';
    const LOCAL_VIEWS_KEY = 'abbys_total_unique_views_v3';
    ...
    try {
      ...
      const countUrl = 'https://api.codetabs.com/v1/counter?key=abbys_site_n1ghtkz5_v3';
      ...
      console.log('Counter sync active:', e);
    }
  }
